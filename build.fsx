...
let summary = "A Slack slash command bot for querying the magic trading card game database"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "A Slack slash command bot for querying the magic trading card game database"

// List of author names (for NuGet package)
let authors = [ "Chet Husk" ]

// Tags for your project (for NuGet package)
let tags = "f# slack magic mtg"

// File system information
let solutionFile  = "SlackTG.sln"
