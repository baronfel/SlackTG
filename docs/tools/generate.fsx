...
let githubLink = "http://github.com/baronfel/SlackTG"

// Specify more information about your project
let info =
  [ "project-name", "SlackTG"
    "project-author", "Chet Husk"
    "project-summary", "A Slack slash command bot for querying the magic trading card game database"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/SlackTG" ]
